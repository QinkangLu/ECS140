...
public class SymTable{
	...
	public void destroyCurrentBlock(){
		//remove from the end
        table.get(table.size()-1).removeAllElements();
	...
	public void addVariable(String variable){
        ...
        if( this.containInCurrent(variable) ){
            ...
            System.out.println(variable+"_"+table.size());
            System.out.println(";");
		}
	}
	...
	public void ensureDeclared(String variable, int linenum, int level, int isGlobal){
		...
		if(level >= table.size()){
			...
			if ( !containInAll(variable) ) {
                ...
                /***C generator***/
                int le = search(variable);
                if(le != -1){
                    //System.err.println("found in level: " + le);
                    //System.err.println(variable + "_" + (le+1));
                    System.out.println(variable + "_" + (le+1));
                } else {
                    System.err.println(variable + " is an undeclared variable on line " + linenum);
                    System.exit(1);
                }
            ...
            if(!containIn(variable, table.size()-1)){
                ...
                /***C generator***/
                System.out.println(variable + "_1");
                /*****************/
            }
        } else {
            if( !containIn(variable, level) ){
                ...
                /***C generator***/
                //System.err.println("debugging" + variable + "_" + (table.size()-level));
                System.out.println(variable + "_" + (table.size()-level));
                /*****************/
            }
        }
    ...
    /* return the level that the closest variable was found */
    public int search(String variable){
